...
cmsDriver.py step1  --conditions auto:run3_hlt_relval -n 5 --era Run3_2024 -s L1REPACK:Full --data --scenario pp --datatier FEVTDEBUGHLT --eventcontent FEVTDEBUGHLT --filein /store/data/Run2024D/JetMET0/RAW/v1/000/380/531/00000/e7a6d94b-a58b-4651-a963-1ba18239c3eb.root --fileout output_step1_L1.root --customise_commands="process.load('Configuration.StandardSequences.Digi_cff') \n process.GlobalTag.DumpStat =cms.untracked.bool(True)" --outputCommands "keep *" |& tee output_step1_L1.log
...
cmsDriver.py step2  --conditions auto:run3_hlt_relval -n 5 --era Run3_2024 -s HLT:@relval2024 --processName HLT2 --data --scenario pp --datatier FEVTDEBUGHLT --eventcontent FEVTDEBUGHLT --filein file:output_step1_L1.root --fileout output_step2_HLT.root --customise_commands='process.GlobalTag.DumpStat=cms.untracked.bool(True)' |& tee output_step2_HLT.log
...
cmsDriver.py step3 --conditions auto:run3_data_prompt_relval -n 5 --era Run3_2024 -s RAW2DIGI,L1Reco,RECO --data --datatier AOD --eventcontent AOD --filein file:output_step2_HLT.root --fileout output_step3_AOD.root --customise_commands='process.GlobalTag.DumpStat =cms.untracked.bool(True)' --customise Configuration/DataProcessing/RecoTLR.customisePostEra_Run3 |& tee output_step3_AOD.log
